...
import { HiPlus, HiTrash, HiUserGroup, HiAcademicCap } from "react-icons/hi";
        ...
        <div className="container mx-auto flex justify-between items-center mt-3">
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              size="sm"
            >
              <Dropdown.Item icon={HiPlus} onClick={() => setOpenCreateModal(true)}>
                Create Group
              </Dropdown.Item>
              <Dropdown.Item icon={HiUserGroup} onClick={() => setOpenJoinModal(true)}>
                Join Group
              </Dropdown.Item>
            </Dropdown>
          </div>
          ...
          {leaderGroups.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {leaderGroups.map((group) => (
                <Card
                  key={group.id}
                  className={`${groupGradients[group.id]} border-none hover:shadow-lg transition-shadow duration-300`}
                >
